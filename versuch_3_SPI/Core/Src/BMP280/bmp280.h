 ...
 *
 * Usage:
 * 1. Create a BMP280_HandleTypedef
 * 2. call bmp280_init_default_params(&bmp280.params); to fill most things
 * 3. set which spi instance it should use
 * 4. call bmp280_init() and check if it worked
 * 5. call bmp280_read_float() whenever you want a reading
 */
#ifndef __BMP280_H__
#define __BMP280_H__
